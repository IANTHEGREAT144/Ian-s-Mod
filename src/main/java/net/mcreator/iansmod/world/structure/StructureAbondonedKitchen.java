...
package net.mcreator.iansmod.world.structure;
...
public class StructureAbondonedKitchen extends ElementsIansMod.ModElement {
	public StructureAbondonedKitchen(ElementsIansMod instance) {
		super(instance, 73);
	}
		...
		if ((random.nextInt(1000000) + 1) <= 50) {
			...
			for (int a = 0; a < count; a++) {
				...
				Template template = ((WorldServer) world).getStructureTemplateManager().getTemplate(world.getMinecraftServer(),
						new ResourceLocation("iansmod", "abandoned_resturant"));
				if (template == null)
					return;
