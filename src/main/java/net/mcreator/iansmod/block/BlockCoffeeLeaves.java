...
public class BlockCoffeeLeaves extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:coffeeleaves")
	public static final Block block = null;
	public BlockCoffeeLeaves(ElementsIansMod instance) {
		super(instance, 2);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("iansmod:coffeeleaves", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemCoffeeBean.block, (int) (4)));
		}
