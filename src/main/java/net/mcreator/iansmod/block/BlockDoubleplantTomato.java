...
public class BlockDoubleplantTomato extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:doubleplanttomato")
	public static final Block block = null;
	public BlockDoubleplantTomato(ElementsIansMod instance) {
		super(instance, 1);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("iansmod:doubleplanttomato", "inventory"));
	}
	...
	public static class BlockCustomFlower extends BlockReed {
		...
		public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
			drops.add(new ItemStack(ItemTomato.block, (int) (3)));
		}
