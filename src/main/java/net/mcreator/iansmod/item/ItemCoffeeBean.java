...
import net.mcreator.iansmod.procedure.ProcedureCoffeeBeanRightClickedOnBlock;
import net.mcreator.iansmod.ElementsIansMod;

@ElementsIansMod.ModElement.Tag
public class ItemCoffeeBean extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:coffeebean")
	public static final Item block = null;
	public ItemCoffeeBean(ElementsIansMod instance) {
		super(instance, 16);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("iansmod:coffeebean", "inventory"));
	}
	public static class ItemCustom extends Item {
		...
		public EnumActionResult onItemUseFirst(EntityPlayer entity, World world, BlockPos pos, EnumFacing direction, float hitX, float hitY,
			...
			int z = pos.getZ();
			{
				...
				ProcedureCoffeeBeanRightClickedOnBlock.executeProcedure($_dependencies);
			}
			return retval;
		}
	}
