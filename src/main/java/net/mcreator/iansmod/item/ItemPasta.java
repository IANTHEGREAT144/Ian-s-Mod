...
public class ItemPasta extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:pasta")
	public static final Item block = null;
	public ItemPasta(ElementsIansMod instance) {
		super(instance, 65);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("iansmod:pasta", "inventory"));
	}
