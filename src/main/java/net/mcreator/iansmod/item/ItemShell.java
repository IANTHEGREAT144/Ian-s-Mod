...
public class ItemShell extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:shell")
	public static final Item block = null;
	public ItemShell(ElementsIansMod instance) {
		super(instance, 32);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("iansmod:shell", "inventory"));
	}
