...
public class ItemFlour extends ElementsIansMod.ModElement {
	@GameRegistry.ObjectHolder("iansmod:flour")
	public static final Item block = null;
	public ItemFlour(ElementsIansMod instance) {
		super(instance, 17);
	}
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(block, 0, new ModelResourceLocation("iansmod:flour", "inventory"));
	}
